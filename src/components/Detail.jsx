  ...
  return (
    <div className="m-5">
      ...
      <div className="row my-3">
        {product?.attributes.imagenes.data && product?.attributes.imagenes.data.length > 0 && (
          <div
        ...
        {!product?.attributes.imagenes.data && 
        <h5 className="text-decoration-underline"> Actualmente no tenemos fotos cargadas para este producto. Muy pronto! </h5>
        }
        <div className="col-12 col-md-4">
          <h4>Categoría: {product?.attributes.categoria}</h4>
        </div>
      </div>
